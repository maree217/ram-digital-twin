...
def main():
    ...
    with st.form("chat_form", clear_on_submit=True):
        user_input = st.text_area("Your message:", height=100, placeholder="Ask me about digital transformation, PMO setup, Dynamics 365, or any business challenge...")
    ...
    st.markdown("---")
    st.markdown("""
    💼 **Ready for a consultation?** Contact Ram: ram@senthilmaree.com  
    🔗 [LinkedIn](https://linkedin.com/in/ramsenthilmaree) | 📅 [Schedule a call](https://calendly.com/ram-senthil-maree)
    """)
